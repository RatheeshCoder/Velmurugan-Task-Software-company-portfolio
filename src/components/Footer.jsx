    ...
    return (
        <footer className=" xl:mt-1 mx-auto w-full relative text-center bg-[#8ebbff] text-[#e3e6df]">
            <div className="px-6 py-8 md:py-14 xl:pt-20 xl:pb-12">
                ...
                <a className="inline-block px-12 py-5 mt-8 text-lg font-medium leading-tight bg-[#e3e6df] text-[#8ebbff] border border-transparent rounded-full shadow-xl xl:mt-12 hover:bg-[#30353b] hover:text-[#e3e6df] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-sky-999 focus:ring-sky-500"
                    href="#">Get
                    started</a>
