            ...
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                ...
                <div className="grid grid-cols-2 gap-4 mt-8 space-y-4 md:mt-16 faq-grid">
                    {questions.map((qa, index) => (
                        <div key={index} className="transition-all duration-200 cursor-pointer hover:bg-[#30353b]">
                            <button type="button" onClick={() => toggleAnswer(index)} className="flex items-center justify-between w-full px-4 py-5 sm:p-6">
                                <span className="flex text-lg font-semibold text-left text-[#e3e6df]">{qa.question}</span>
