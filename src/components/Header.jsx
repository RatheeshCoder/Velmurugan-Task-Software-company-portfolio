        ...
        <nav className="bg-[#121315] border-gray-200 py-2.5 dark:bg-gray-900">
            <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                <a href="#" className="flex items-center">
                    ...
                    <span className="self-center text-xl font-semibold whitespace-nowrap text-[#8ebbff]">Comany Name</span>
                </a>
                <div className="flex items-center lg:order-2">
                    ...
                    <a href="https://themesberg.com/product/tailwind-css/landing-page"
                        className="text-[#e3e6df] bg-[#8ebbff] animate-pulse focus:ring-4 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0  focus:outline-none hover:animate-none transition-none mx-10">Download</a>
